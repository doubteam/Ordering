...
public class DishesListAdapter extends ArrayAdapter<TheDishes>{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView tvPrice = (TextView) view
				.findViewById(R.id.activity_disheslistadapter_item_txt_goodsprice);
		final ImageView image = (ImageView) view
				.findViewById(R.id.activity_disheslistadapter_item_img);
		Button btnOrder=(Button)view.findViewById(R.id.activity_disheslistadapter_item_btn_order);
